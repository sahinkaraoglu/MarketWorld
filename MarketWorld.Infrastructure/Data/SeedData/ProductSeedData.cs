...
namespace MarketWorld.Infrastructure.Data.SeedData
{
    public static class ProductSeedData
    {
        ...
        private static readonly HashSet<int> _usedProductCodes = new HashSet<int>();

        private static int GenerateUniqueProductCode()
        {
            int productCode;
            do
            {
                productCode = _random.Next(100000, 1000000);
            } while (_usedProductCodes.Contains(productCode));
            
            _usedProductCodes.Add(productCode);
            return productCode;
        }
