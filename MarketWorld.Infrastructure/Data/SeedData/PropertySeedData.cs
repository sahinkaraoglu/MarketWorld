    ...
    public static class PropertySeedData
    {
        ...
        public static List<PropertyValue> GetPropertyValues()
        {
            return new List<PropertyValue>
            {
                ...
                // iPhone 14 Pro Hafıza Seçenekleri
                new PropertyValue { Id = 5, PropertyTypeId = 2, Value = "128GB", CreatedDate = DateTime.Now },
                new PropertyValue { Id = 6, PropertyTypeId = 2, Value = "256GB", CreatedDate = DateTime.Now },
                new PropertyValue { Id = 7, PropertyTypeId = 2, Value = "512GB", CreatedDate = DateTime.Now },
                new PropertyValue { Id = 8, PropertyTypeId = 2, Value = "1TB", CreatedDate = DateTime.Now }
            };
        }
