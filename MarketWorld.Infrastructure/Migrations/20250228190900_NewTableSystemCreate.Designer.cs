...
namespace MarketWorld.Infrastructure.Migrations
{
    ...
    [Migration("20250228190900_NewTableSystemCreate")]
    partial class NewTableSystemCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketWorld.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8643),
                        ...
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8659),
                        ...
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8660),
                        ...
                        {
                            Id = 4L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8661),
                        ...
                        {
                            Id = 5L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8662),
            ...
            modelBuilder.Entity("MarketWorld.Domain.Entities.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CategoryId = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8740),
                        ...
                        new
                        {
                            Id = 2L,
                            CategoryId = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8789),
                        ...
                        new
                        {
                            Id = 3L,
                            CategoryId = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8791),
                        ...
                        new
                        {
                            Id = 4L,
                            CategoryId = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8792),
                        ...
                        new
                        {
                            Id = 5L,
                            CategoryId = 1L,
                            CreatedDate = new DateTime(2025, 2, 28, 22, 9, 0, 599, DateTimeKind.Local).AddTicks(8793),
